                      ...
                      return (
                        <Alert severity="warning" icon={false} sx={{ mt: 1.25 }}>
                          ...
                          <Typography variant="body2" sx={{ mb: 0.5 }}>
                            Pengiriman Blast ini dihentikan sementara oleh WhatsApp, bukan oleh Ruangkirim. Saat Ruangkirim mengirim pesan Anda, WhatsApp menolaknya dan meminta pengiriman dihentikan, lalu Ruangkirim langsung menjeda Blast agar nomor Anda tetap aman. Nomor Anda tidak terblokir permanen.
                          </Typography>
                          <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mb: 1 }}>
                            {at ? `Keputusan ini diberikan langsung oleh WhatsApp pada ${at}. ` : ''}Ruangkirim tidak memblokir pesan Anda.
                          </Typography>
