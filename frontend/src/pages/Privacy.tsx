...
const SECTIONS: { h: string; p: string[] }[] = [
  {
    h: '1. Pengantar',
    p: [
      'Kebijakan Privasi ini menjelaskan bagaimana Ruangkirim mengumpulkan, menggunakan, dan melindungi data kamu saat memakai layanan asisten WhatsApp bertenaga AI kami. Dengan mendaftar dan menggunakan Ruangkirim, kamu menyetujui praktik yang dijelaskan di halaman ini.',
    ],
  },
  {
  ...
  },
  {
    h: '10. Kontak',
    p: [
      'Jika ada pertanyaan tentang Kebijakan Privasi ini, hubungi kami di halo@ruangkirim.web.id.',
    ],
  },
];
