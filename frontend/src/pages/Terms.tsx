...
import heroLogo from '../assets/logo-ruangkirim.png';

const SECTIONS: { h: string; p: string[] }[] = [
  {
    h: '1. Penerimaan ketentuan',
    p: [
      'Dengan mendaftar dan menggunakan Ruangkirim, kamu menyetujui Syarat dan Ketentuan ini. Jika kamu tidak setuju, mohon untuk tidak menggunakan layanan.',
    ],
  },
  {
    h: '2. Tentang layanan',
    p: [
      'Ruangkirim adalah layanan asisten WhatsApp bertenaga AI yang membantu bisnis membalas pelanggan secara otomatis, mengelola kontak, broadcast, pesan terjadwal, follow up, dan fitur terkait lainnya.',
    ],
  },
  {
  ...
  },
  {
    ...
    p: [
      'Kamu dilarang menggunakan Ruangkirim untuk mengirim spam, penipuan, konten ilegal, atau melanggar hukum yang berlaku.',
  ...
  },
  {
    ...
    p: [
      'Ruangkirim terhubung ke WhatsApp melalui fitur perangkat tertaut. Penggunaan otomatisasi, balasan massal, dan broadcast membawa risiko nomor WhatsApp dibatasi atau diblokir oleh pihak WhatsApp.',
      'Risiko ini berada di luar kendali kami. Kamu menggunakan fitur otomatisasi dan broadcast atas tanggung jawab sendiri, dan Ruangkirim tidak bertanggung jawab atas pemblokiran nomor yang terjadi.',
    ],
  },
  {
    h: '8. Batasan tanggung jawab',
    p: [
      'Layanan disediakan apa adanya. Sejauh diizinkan hukum, Ruangkirim tidak bertanggung jawab atas kerugian tidak langsung, kehilangan keuntungan, atau kehilangan data yang timbul dari penggunaan layanan.',
    ],
  },
  {
    h: '9. Penghentian',
  ...
  },
  {
    h: '12. Kontak',
    p: [
      'Untuk pertanyaan tentang ketentuan ini, hubungi kami di halo@ruangkirim.web.id.',
    ],
  },
];
    ...
    <Box sx={{ bgcolor: 'background.default', minHeight: '100vh' }}>
      <Box sx={{ borderBottom: '1px solid', borderColor: 'divider', bgcolor: '#fff' }}>
        <Container maxWidth="md" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', py: 1.5 }}>
          <Box component="img" src={heroLogo} alt="Ruangkirim" sx={{ height: 34, cursor: 'pointer' }} onClick={() => navigate('/')} />
      ...
      <Container maxWidth="md" sx={{ py: { xs: 5, md: 8 } }}>
        ...
        <Divider sx={{ my: 4 }} />
        <Typography variant="caption" color="text.secondary">© {new Date().getFullYear()} Ruangkirim. Seluruh hak cipta dilindungi.</Typography>
      </Container>
    </Box>
  );
}
